...
#                break
            ...
            for item in resultlist:
                ...
                if not (face_x > 0 and face_y > 0 and face_angle > 0.5):
                    flag=0
            if flag ==1:
                s=mypath+imgname+" "+str(len(resultlist))
                for item in resultlist:
                    [face_id, face_x, face_y, face_w, face_h, face_angle] = item
                    s+=" "+str(face_x)+" "+str(face_y)+" "+str(face_w)+" "+str(face_h)
                s+="\n"
                left_pos.write(s)
            # print resultlist
            # for item in resultlist:
...
#                break
            ...
            for item in resultlist:
                [face_id, face_x, face_y, face_w, face_h, face_angle] = item
                if not (face_x > 0 and face_y > 0 and face_angle > -0.5 and face_angle < 0.5):
                    flag=0
