...
for i in $(seq 11 100); do
	figure1="/home/capstone/pipeline/image_test"
	figure2=".JPG"
	#figure=$figure1$i$figure2
	figure=$(echo "/home/capstone/pipeline/image_test/"$i".JPG")
	outfile=$(echo "/home/capstone/pipeline/result_1124_2/"$i"_out.jpg")
	rm -rf /home/capstone/pipeline/AdaBoost_to_CNN/detected_faces/*
	/home/capstone/pipeline/AdaBoost_to_CNN/AdaBoost_Test_less $figure
